...
def write_test_results_file(tagger_type, predictions_list):
    with open("data/" + tagger_type.lower() + "/test", 'r') as test_file, open("test3." + tagger_type.lower(), 'w') as output_file:
...
def plot_graphs(tagger_type, train_loss, dev_loss, dev_accuracy):
    ...
    plt.savefig(tagger_type + "3 train_loss.png")
    ...
    plt.savefig(tagger_type + "3 dev_loss.png")
    ...
    plt.savefig(tagger_type + "3 dev_acc.png")
